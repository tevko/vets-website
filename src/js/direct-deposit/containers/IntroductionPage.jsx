  ...
  render() {
    return (
      <div className="schemaform-intro">
        <FormTitle title="Direct Deposit Enrollment"/>
        <p>Equal to VA Form 24-0296 (Direct Deposit Enrollment).</p>
        <SaveInProgressIntro
          ...
          Please complete the 24-0296 form to apply for direct deposit.
        </SaveInProgressIntro>
        <h4>Follow the steps below to apply for direct deposit.</h4>
        <div className="process schemaform-process">
          <ol>
            ...
            <li className="process-step list-two">
              <div><h5>Apply</h5></div>
              <p>Complete this direct deposit form.</p>
        ...
        <div className="omb-info--container" style={{ paddingLeft: '0px' }}>
          <OMBInfo resBurden={15} ombNumber="2900-0564" expDate="02/28/2019"/>
        </div>
      </div>
    );
  }
